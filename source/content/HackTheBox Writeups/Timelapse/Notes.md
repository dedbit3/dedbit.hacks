this is a domain controller. Running LDAP, RPC, kerberus all that
...
88/tcp    open  kerberos-sec      syn-ack ttl 127 Microsoft Windows Kerberos (server time: 2024-11-16 05:28:26Z)
...
|_ssl-date: 2024-11-16T05:30:00+00:00; +8h00m00s from scanner time.
...
|   Check 2 (port 13419/tcp): CLEAN (Timeout)
|   Check 3 (port 22941/udp): CLEAN (Timeout)
|   Check 4 (port 61330/udp): CLEAN (Timeout)
...
---
 ...
 # ======================================
|    Shares via RPC on 10.10.11.152    |
 ======================================
[*] Enumerating shares
[+] Found 6 share(s):
ADMIN$:
